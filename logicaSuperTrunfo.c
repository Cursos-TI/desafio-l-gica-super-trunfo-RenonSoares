...
int main()
{
    ...
    case 1:
        ...
        printf("COMPARAÇÃO DE CARTAS\n"); // Adição do menu para escolha do atributo a ser comparado.
        ...
        switch (atributo) // comando switch para efetuar a comparação de um atributo a partir da escolha do atributo
        {
        case 1:
